...
export default function DashboardHomeContent({ userImage, userName }: DashboardHomeContentProps) {
  return (
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
        ...
        <div className="space-y-3">
          <div className="flex items-center space-x-3 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
            ...
            <div>
              <p className="text-sm font-medium text-gray-900 dark:text-white">Order PZA018 delivered</p>
              <p className="text-xs text-gray-600 dark:text-gray-400">Stephanie Walker - Spicy Italian</p>
            </div>
          </div>
          <div className="flex items-center space-x-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            <Clock className="h-5 w-5 text-blue-600 dark:text-blue-400" />
            <div>
              <p className="text-sm font-medium text-gray-900 dark:text-white">Order PZA020 received</p>
              <p className="text-xs text-gray-600 dark:text-gray-400">Laura Young - Pepperoni</p>
            </div>
          </div>
          <div className="flex items-center space-x-3 p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
            <TrendingUp className="h-5 w-5 text-yellow-600 dark:text-yellow-400" />
            <div>
              <p className="text-sm font-medium text-gray-900 dark:text-white">Order PZA019 in preparation</p>
              <p className="text-xs text-gray-600 dark:text-gray-400">Brian Hall - Margherita</p>
            </div>
          </div>
        </div>
      </div>
